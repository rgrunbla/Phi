...
class DroneSimulation : public Simulation {
    ...
    void init() { }
    void environment() { }
    void handleMeso(int32_t meso_type, std::string meso_content) { }
        ...
        for (auto agent_info: agents.infos()) {
            ...
            for(Value val : agent_info.values()) {
                ...
                if(val.has_integers()) {
                    ...
                    this->agents[i]->generic_store[val.name()]->set(std::vector<float>(val.floats().values().begin(), val.floats().values().end()));
                } else if (val.has_doubles()) {
                    this->agents[i]->generic_store[val.name()]->set(std::vector<double>(val.doubles().values().begin(), val.doubles().values().end()));
                } else if (val.has_strings()) {
                    this->agents[i]->generic_store[val.name()]->set(std::vector<std::string>(val.strings().values().begin(), val.strings().values().end()));
                } else {
                ...
                for(MapValue map_value: map.values()) {
                    if(map_value.key_case() == 1) { /* Int */
                        if(map_value.has_integers()) {
                            this->agents[i]->generic_map_store[map.name()]->set(map_value.int_key(), std::vector<int>(map_value.integers().values().begin(), map_value.integers().values().end()));
                        } else if(map_value.has_floats()) {
                            this->agents[i]->generic_map_store[map.name()]->set(map_value.int_key(), std::vector<float>(map_value.floats().values().begin(), map_value.floats().values().end()));
                        } else if(map_value.has_doubles()) {
                            this->agents[i]->generic_map_store[map.name()]->set(map_value.int_key(), std::vector<double>(map_value.doubles().values().begin(), map_value.doubles().values().end()));
                        } else if(map_value.has_strings()) {
                            this->agents[i]->generic_map_store[map.name()]->set(map_value.int_key(), std::vector<std::string>(map_value.strings().values().begin(), map_value.strings().values().end()));
                        } else {
                            std::cout << "Map has no data!\n";
                        }
                    } else if(map_value.key_case() == 2) { /* Float */
                        if(map_value.has_integers()) {
                            this->agents[i]->generic_map_store[map.name()]->set(map_value.float_key(), std::vector<int>(map_value.integers().values().begin(), map_value.integers().values().end()));
                        } else if(map_value.has_floats()) {
                            this->agents[i]->generic_map_store[map.name()]->set(map_value.float_key(), std::vector<float>(map_value.floats().values().begin(), map_value.floats().values().end()));
                        } else if(map_value.has_doubles()) {
                            this->agents[i]->generic_map_store[map.name()]->set(map_value.float_key(), std::vector<double>(map_value.doubles().values().begin(), map_value.doubles().values().end()));
                        } else if(map_value.has_strings()) {
                            this->agents[i]->generic_map_store[map.name()]->set(map_value.float_key(), std::vector<std::string>(map_value.strings().values().begin(), map_value.strings().values().end()));
                        } else {
                            std::cout << "Map has no data!\n";
                        }
                    } else if(map_value.key_case() == 3) { /* Double */
                        if(map_value.has_integers()) {
                            this->agents[i]->generic_map_store[map.name()]->set(map_value.double_key(), std::vector<int>(map_value.integers().values().begin(), map_value.integers().values().end()));
                        } else if(map_value.has_floats()) {
                            this->agents[i]->generic_map_store[map.name()]->set(map_value.double_key(), std::vector<float>(map_value.floats().values().begin(), map_value.floats().values().end()));
                        } else if(map_value.has_doubles()) {
                            this->agents[i]->generic_map_store[map.name()]->set(map_value.double_key(), std::vector<double>(map_value.doubles().values().begin(), map_value.doubles().values().end()));
                        } else if(map_value.has_strings()) {
                            this->agents[i]->generic_map_store[map.name()]->set(map_value.double_key(), std::vector<std::string>(map_value.strings().values().begin(), map_value.strings().values().end()));
                        } else {
                            std::cout << "Map has no data!\n";
                        }
                    } else if(map_value.key_case() == 4) { /* String */
                        if(map_value.has_integers()) {
                            this->agents[i]->generic_map_store[map.name()]->set(map_value.string_key(), std::vector<int>(map_value.integers().values().begin(), map_value.integers().values().end()));
                        } else if(map_value.has_floats()) {
                            this->agents[i]->generic_map_store[map.name()]->set(map_value.string_key(), std::vector<float>(map_value.floats().values().begin(), map_value.floats().values().end()));
                        } else if(map_value.has_doubles()) {
                            this->agents[i]->generic_map_store[map.name()]->set(map_value.string_key(), std::vector<double>(map_value.doubles().values().begin(), map_value.doubles().values().end()));
                        } else if(map_value.has_strings()) {
                            this->agents[i]->generic_map_store[map.name()]->set(map_value.string_key(), std::vector<std::string>(map_value.strings().values().begin(), map_value.strings().values().end()));
                        } else {
                            std::cout << "Map has no data!\n";
                        }
                    } else {
    ...
    std::vector<float> get_position_buffer() {
        ...
        for(auto agent: this->agents) {
            //std::cout << "Agent " << i << ", " << agent.type << ", " << glm::to_string(agent->get_position()) << ", " << glm::to_string(agent.orientation) << "\n";
...
int main(int, char**)
{
    ...
    // We generate a texture image and we attach it as a color attachement to the framebuffer
    ...
    // We generate a renderbuffer object that will be used to enable depth testing (and stencil testing)
    unsigned int rbo;
    ...
    // Attach renderbuffer object to the depth and stencil attachement of the framebuffer
    ...
    for (float x=-0.01; x<=gridSize; x+=(gridSize/gridSubdivision)) {
        gridVertices.push_back(x); gridVertices.push_back(0.0); gridVertices.push_back(0.0); gridVertices.push_back(1.0);
        gridVertices.push_back(x); gridVertices.push_back(gridSize); gridVertices.push_back(0.0); gridVertices.push_back(1.0);
    }

    for (float y=-0.01; y<=gridSize; y+=(gridSize/gridSubdivision)) {
        gridVertices.push_back(0.0); gridVertices.push_back(y); gridVertices.push_back(0.0); gridVertices.push_back(1.0);
        gridVertices.push_back(gridSize); gridVertices.push_back(y); gridVertices.push_back(0.0); gridVertices.push_back(1.0);
    }
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(float)*gridVertices.size(), &gridVertices.front(), GL_DYNAMIC_DRAW);
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(float)*nodes.size(), &nodes.front(), GL_DYNAMIC_DRAW);
    ...
    zmq::socket_t* zmq_socket = new zmq::socket_t(*zmq_context, zmq::socket_type::sub);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if (items[0].revents & ZMQ_POLLIN) {
            ...
            switch(viz.type()) {
                case Viz_MessageType_POSITIONS:
                    simulations[viz.simulation_id()].parse_agent_infos(viz.content());
                    break;
                case Viz_MessageType_THROUGHPUTS:
                    // simulations[viz.simulation_id()].parse_agent_throughputs(viz.content(), (float) viz.clock());
                    break;
                default:
        ...
        ImGui::Begin("Display Configuration");   // Pass a pointer to our bool variable (the window will have a closing button that will clear the bool when clicked)
        ...
        if(plot) {
            for(auto agent: simulations[current_simulation].agents) {
                if(agent->generic_map_store.find("power_curves") != agent->generic_map_store.end()) {
                    ImGui::Begin((agent->get_type() + " " + std::to_string(agent->get_id())).c_str());
                    ...
                    if(agent->generic_store.find("goal") != agent->generic_store.end()) {
                        double goal_cursor = std::get<int>(agent->generic_store["goal"]->get(0))*(wMax.x - wMin.x)/360.0f;
                        ImGui::GetWindowDrawList()->AddLine(ImVec2(wMin.x+goal_cursor, wMin.y), ImVec2(wMin.x+goal_cursor, wMax.y), ImGui::GetColorU32(ImVec4(1.0, 0.0, 0.0, 1.0)), 6.0f);
                    }


                    if(agent->generic_store.find("angle") != agent->generic_store.end()) {
                        double angle_cursor = std::get<int>(agent->generic_store["angle"]->get(0))*(wMax.x - wMin.x)/360.0f;
                        ImGui::GetWindowDrawList()->AddLine(ImVec2(wMin.x+angle_cursor, wMin.y), ImVec2(wMin.x+angle_cursor, wMax.y), ImGui::GetColorU32(ImVec4(0.0, 1.0, 0.0, 1.0)), 2.0f);
                    }

                    std::vector<std::vector<float>> data(agent->generic_map_store["power_curves"]->size());
                    const float* y_data[agent->generic_map_store["power_curves"]->size()];
                    int i = 0;
                    for(const auto& [key, arr]: *(agent->generic_map_store["power_curves"])) {
                        for(auto v: std::get<std::vector<double>>(arr)) data[i].push_back(v);
                    ...
                    conf.values.ys_count = agent->generic_map_store["power_curves"]->size();
                    conf.scale.min = -100;
                    conf.scale.max = 0;
            ...
            /*            
            for(const auto& [key, arr]: simulations[current_simulation].flows) {
                ImGui::Begin(("Flow " + key.first + " -> " + key.second).c_str());
                ImVec2 wMin = ImGui::GetWindowContentRegionMin();
                ImVec2 wMax = ImGui::GetWindowContentRegionMax();
                wMin.x += ImGui::GetWindowPos().x;
                wMin.y += ImGui::GetWindowPos().y;
                ...
                ImGui::PlotConfig conf;
                conf.values.count = arr.first.size();
                conf.values.xs = arr.first.data();
                conf.values.ys = arr.second.data();
                conf.scale.min = 0;
                conf.scale.max = 80;
                conf.tooltip.show = true;
                conf.tooltip.format = "x=%.2f, y=%.2f";
                ...
                conf.grid_y.show = true;
                conf.grid_y.size = 10.0f;
                conf.grid_x.size = 5.0f;
                conf.grid_x.subticks = 1.0f;
                conf.frame_size = ImVec2(wMax.x-wMin.x, wMax.y-wMin.y);
                conf.line_thickness = 2.f;
        ...
        glBindVertexArray(gridVAO);
            glBindBuffer(GL_ARRAY_BUFFER, gridVBO);
                ...
                glVertexAttribPointer(gridAttr, 4, GL_FLOAT, GL_FALSE, 0, (void *) 0);
                    ...
                    int gridProjectionLocation = glGetUniformLocation(gridShaderProgram, "projection");
                    ...
                    glm::mat4 projection = glm::perspective(glm::radians(55.0f), 1.0f, 0.1f, 800.0f) * flip;
                    glUniformMatrix4fv(gridProjectionLocation, 1, GL_FALSE, glm::value_ptr(projection));
                    glm::mat4 view =  glm::lookAt(glm::vec3(1/zoom, 1/zoom, 1/zoom), glm::vec3(0.0, 0.0, 0.0), glm::vec3(0, 0, 1));
        ...
        glBindVertexArray(nodesVAO); 
            glBindBuffer(GL_ARRAY_BUFFER, nodesVBO);
                ...
                int nodesProjectionLocation = glGetUniformLocation(nodesShaderProgram, "projection");
                ...
                glUniformMatrix4fv(nodesProjectionLocation, 1, GL_FALSE, glm::value_ptr(projection));
        ...
        ImGui::Image((void*)(intptr_t)texColorBuffer, ImVec2(vMax.x - vMin.x, vMax.y - vMin.y));
        ImGui::End();
